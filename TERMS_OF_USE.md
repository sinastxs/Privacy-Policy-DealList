...
## 1. What DealList Provides

DealList helps users search grocery flyer deals, available regular prices, and shopping list information for supported regions in Canada and the United States.

The App is intended for general shopping reference only. DealList does not sell groceries, process grocery orders, reserve products, or represent any grocery retailer.

## 2. Price and Availability Information

Prices, promotions, flyer availability, product availability, store participation, dates, images, and product details may change at any time.

DealList works to keep information accurate and up to date, but we do not guarantee that all information is complete, current, error-free, or available immediately after retailers release new flyers or price changes.
...
Retailer names, product names, logos, images, and trademarks belong to their respective owners and are used for identification and shopping reference purposes.
...
## 5. Subscriptions and Ad Removal
...
The free version of the App may display ads. Ads may be provided by third-party advertising services. Ad content, targeting, and measurement may be subject to the privacy policies and terms of those third-party services.

## 7. Third-Party Services

DealList may use third-party services for app functionality, including but not limited to hosting, database storage, analytics, advertising, translation, app updates, and subscription management.

These third-party services may have their own terms and privacy policies. DealList is not responsible for third-party services, websites, data sources, or content that we do not control.
...
To the fullest extent permitted by law, DealList disclaims all warranties, including warranties of accuracy, reliability, availability, merchantability, fitness for a particular purpose, and non-infringement.

## 11. Limitation of Liability

To the fullest extent permitted by law, DealList and its developer will not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, or for any loss related to your use of or inability to use the App.
